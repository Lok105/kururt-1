...
class ServicesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'parent_id' => ['type' => 'integer', 'length' => 255, 'unsigned' => true, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'short' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        ...
        'published' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => '1', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-01-07 15:02:08',
                'modified' => '2019-01-07 15:02:08'
            ],
        ];
        parent::init();
    }

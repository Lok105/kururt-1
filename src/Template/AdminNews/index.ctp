<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="buttons-block">
                <?= $this->Html->link(__('Добавить новость'), ['action' => 'add'], ['class' => 'btn btn-primary']) ?>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="product-form">
                <?php echo $this->Form->create('search', ['type' => 'get']); ?>
                        <div class="form-group input-group">
                            <input class="form-control" type="text" name="search" placeholder="Найти новость">
                ...
                <table class="table table-hover table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col"><?= $this->Paginator->sort('h1', 'H1 <i class="fa fa-sort" aria-hidden="true"></i>', ['escape' => false]) ?></th>
                            ...
                            <th scope="col" style="text-align: center;"><?= $this->Paginator->sort('show_index', 'На главной <i class="fa fa-sort" aria-hidden="true"></i>', ['escape' => false]) ?></th>
                    ...
                    <?php if($pages) : ?>
                        ...
                        <tr>
                            ...
                            <td><a href="/news/<?php echo $product->alias; ?>" target="_blank"><?= h($product->title) ?></a></td>
                            <td><?= h($product->h1) ?></td>
    ...
    <div class="row">
        <div class="col-xs-12">
            <h2>Редактор основной страницы "Новости"</h2>        
                <div class="news form large-9 medium-8 columns content">
                    <?= $this->Form->create($information, ['type' => 'file']) ?>
                    <fieldset>
                        <div class="form-group">
                            <?php echo $this->Form->input('title', ['label' => 'Title основной страницы Новости', 'class' => 'default-fild form-control']); ?>
                        </div>
                        <div class="form-group">
                            <?php echo $this->Form->input('description', ['label' => 'Description основной страницы Новости', 'class' => 'default-fild form-control', 'type' => 'text']); ?>
                        </div>                        
                        <div class="form-group">
                            <?php echo $this->Form->input('h1', ['label' => 'Заголовок H1 для страницы Новости', 'class' => 'default-fild form-control', 'type' => 'text']); ?>
                        </div>                     
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <?php echo $this->Form->input('body', ['label' => 'Текст для основной страницы Новости', 'class' => 'default-fild form-control', 'id' => 'block1']); ?>
                    ...
                    <fieldset>
                        <div class="dop-img-block">
                          ...
                          <fieldset class="article-img">
                            <label class="dop-img-title">Выберите изображение фона для основной страницы "Новости"</label>

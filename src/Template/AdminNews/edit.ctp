<div class="container-fluid">
    ...
    <div class="page-header">
        <h1>Редактор новости "<?php echo $page->h1; ?>"</h1>
    </div>
    <div class="row">
        <div class="col-xs-12">
            <div class="buttons-block">
                <?= $this->Html->link(__('Список новостей'), ['controller' => 'AdminNews', 'action' => 'index'], ['class' => 'btn btn-primary']) ?>            
            </div>
        </div>
    </div>
    <div class="row">
                ...
                <div class="news form large-9 medium-8 columns content">
                    ...
                    <fieldset>
                        <div class="dop-img-block">
                            <div class="line-add-title">Изображение новости для предпросмотра</div>                    

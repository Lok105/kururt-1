                ...
                <table class="table table-hover table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col"><?= $this->Paginator->sort('text', 'Текст слайда <i class="fa fa-sort" aria-hidden="true"></i>', ['escape' => false]) ?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo $slide->url; ?>" target="_blank"><?= h($slide->title) ?></a></td>

    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="buttons-block">
                <?= $this->Html->link(__('Весь список слайдов'), ['action' => 'index'], ['class' => 'btn btn-primary']) ?>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12">
                <div class="news form large-9 medium-8 columns content">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <?php echo $this->Form->input('text', ['label' => 'Текст', 'class' => 'default-fild form-control']); ?>                           
                        </div>
                        <div class="form-group">
                        ...
                        <div class="checkbox">
                            <?php echo $this->Form->input('show_form', ['label' => 'Показать форму заказа', 'class' => 'default-fild form-control', 'type' => 'checkbox']); ?>
                        </div> 
                        ...
                        <div class="clearfix"></div>
                          ...
                          <fieldset class="article-img">
                            <label>Слайд (Размер 1920/751)</label>
                            <div class="clear"></div>
                            <span id="preview-top">

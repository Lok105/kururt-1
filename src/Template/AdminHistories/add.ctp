<div class="container-fluid">
    ...
    <div class="page-header">
        <h1>Добавление карточки истории</h1>
    </div>
    <div class="row">
        <div class="col-xs-12">
            <div class="buttons-block">
                <?= $this->Html->link(__('Весь список исторических моментов'), ['action' => 'index'], ['class' => 'btn btn-primary']) ?>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12">
                <div class="news form large-9 medium-8 columns content">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <?php echo $this->Form->input('year', ['label' => 'Год', 'class' => 'default-fild form-control']); ?>
                        </div> 
                        ...
                        <div class="clearfix"></div>
                          ...
                          <fieldset class="article-img">
                            <label>Миниатюра (Размер 225/150)</label>
                            <div class="clear"></div>
                            <span id="preview-top">

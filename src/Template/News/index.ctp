...
<section class="service-area ptb-100 bg-1">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="paginator pagination-wrap">
                    <ul class="pagination1">
                        <?= $this->Paginator->first('<i class="fa fa-angle-left"></i>', ['escape' => false]) ?>
                        <?= $this->Paginator->numbers() ?>
                        <?= $this->Paginator->last('<i class="fa fa-angle-right"></i>', ['escape' => false]) ?>
                    </ul>
                </div>
            </div>
        </div>

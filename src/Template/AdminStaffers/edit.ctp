<div class="container-fluid">
    ...
    <div class="page-header">
        <h1>Редактор сотрудника <?php echo $staffer->name; ?></h1>
    </div>
    <div class="row">
        <div class="col-xs-12">
                        ...
                        <div class="clearfix"></div>                          
                          ...
                          <fieldset class="article-img">
                            ...
                            <span id="preview-top">
                                <div id="top_banner_img">
                                    <div class="top_banner_img article-img">
                                        <?php if($staffer->img) : ?>
                                            <img style="max-width: 50%;width: auto;" src="/img/upload/<?php echo $staffer->img; ?>"/>
                                        <?php endif; ?>        
                                    </div>
                                </div>
                            </span>
                            <div class="file-put article-put">        
                                ...
                                <?php echo $this->Form->input('last_img', ['type' => 'hidden', 'value' => $staffer->img]); ?>
                            </div>

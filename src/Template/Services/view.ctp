<?php $this->Html->addCrumb('Услуги', ['controller' => 'Services', 'action' => 'index']); ?>
<?php if(isset($crumbs['one'])) : ?>
    <?php if(isset($crumbs['two'])) : ?>
        <?php $this->Html->addCrumb($crumbs['one']['title'], ['controller' => 'Services', 'action' => 'view', $crumbs['one']['alias']]); ?>
    <?php else : ?>
...
<?php if(isset($crumbs['two'])) : ?>
    <?php if(isset($crumbs['three'])) : ?>
        <?php $this->Html->addCrumb($crumbs['two']['title'], ['controller' => 'Services', 'action' => 'view', $crumbs['two']['alias']]); ?>
    <?php else : ?>
...
<?php if(isset($crumbs['three'])) : ?>
    <?php if(isset($crumbs['fore'])) : ?>
        <?php $this->Html->addCrumb($crumbs['three']['title'], ['controller' => 'Services', 'action' => 'view', $crumbs['three']['alias']]); ?>
    <?php else : ?> 

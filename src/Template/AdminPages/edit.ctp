    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="buttons-block">
                <?= $this->Html->link(__('Список страниц'), ['controller' => 'AdminPages', 'action' => 'index'], ['class' => 'btn btn-primary']) ?> 
                <?= $this->Form->postLink(
                                'Удалить страницу',
                                ['action' => 'delete', $page->id],
                                ['confirm' => __('Восстановление страницы будет невозможно', $page->id), 'class' => 'btn btn-primary']
                            )
                        ?>                           
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xs-12">
                <div class="news form large-9 medium-8 columns content">
                    ...
                    <fieldset>
                        <label>Принадлежность страниц</label>
                        <div class="form-group">
                            <?php echo $this->Form->select('parent_id', $page_select, ['class' => 'default-fild form-control', 'empty' => 'Родительская/Самостоятельная страница']); ?>
                        </div>
                      
                        <div class="form-group">
                            <?php echo $this->Form->input('title', ['label' => 'Название страницы | title', 'class' => 'default-fild form-control', 'required' => true, 'id' => 'title']); ?>
                        </div>                                            
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <p class="help-block">Если оставить пустым, пунктом меню будет Название страницы | title</p>
                        </div>
                        <div class="form-group">
                            <?php echo $this->Form->input('short', ['label' => 'Краткое описание для анонса', 'class' => 'default-fild form-control']); ?>
                        </div>
                        <div class="form-group">
                            <?php echo $this->Form->input('body', ['label' => 'Содержимое страницы', 'class' => 'default-fild form-control', 'id' => 'block1']); ?>
                        ...
                        <div class="form-group">
                            ...
                            <p class="help-block">Если оставить пустым, будет использоваться стандартный</p>
                        </div>                        
                        <div class="form-group">
                        ...
                        <div class="clearfix"></div>
                        <div class="checkbox">
                            <?php echo $this->Form->input('bottom_menu', ['label' => 'Отображать в нижнем меню', 'class' => 'default-fild form-control', 'type' => 'checkbox']); ?>
                        </div> 
                        <div class="clearfix"></div>                                                                                                
                        <div class="form-group">
                    ...
                    <fieldset>
                        <div class="dop-img-block">
                            <div class="line-add-title">Изображение страницы для предпросмотра (Размер 400/320)</div>                    
                          <fieldset class="article-img">
                        
                            <label>Изображение страницы</label>
                            <div class="clear"></div>
                            <span id="preview-top">
                                <div id="top_banner_img">
                                    <div class="top_banner_img article-img">
                                        <?php if($page->img) : ?>
                                            <img style="max-width: 100%;width: auto;" src="/img/upload/<?php echo $page->img; ?>"/>
                                        <?php endif; ?>        
                                    </div>
                                </div>
                            </span>
                            <div class="file-put article-put">        
                                ...
                                <?php echo $this->Form->input('last_img', ['type' => 'hidden', 'value' => $page->img]); ?>
                            </div>
                          ...
                          <fieldset class="article-img">
                            ...
                            <span id="preview-top1">
                                <div id="top_banner_img1">
                                    <div class="top_banner_img article-img">
                                        <?php if($page->back) : ?>
                                            <img style="max-width: 100%;width: auto;" src="/img/upload/<?php echo $page->back; ?>"/>
                                        <?php endif; ?>        
                                    </div>
                                </div>
                            </span>
                            <div class="file-put article-put">        
                                ...
                                <?php echo $this->Form->input('last_img1', ['type' => 'hidden', 'value' => $page->back]); ?>
                            </div>
                    ...
                    <?= $this->Form->button('Сохранить', ['class' => 'btn btn-primary', 'name' => 'saveType', 'value' => 'back']) ?>
                    <?= $this->Form->end() ?>
                </div>
        </div>                
    </div>

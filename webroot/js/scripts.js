(function ($) {
 "use strict";
    ...
    $('form#cf button#submit').on('click', function() {
        ...
        if (!regex.test(email)) {
            alert('Пожалуйста укажите правильный e-mail');
            return false;
        }else{
            return true;
        }
        ...
        if (fname != '' && email != '' && msg != '') {
            ...
            $.ajax({
                ...
                success: function() {
                    ...
                    $('.cf-msg').fadeIn().html('<div class="alert alert-success">Ваше сообщение успешно отправлено!</div>');
                    setTimeout(function() {
                        $('.cf-msg').fadeOut('slow');
                    }, 4000);
                }
            ...
            $('.cf-msg').fadeIn().html('<div class="alert alert-danger">Ошибка отправки сообщения, попробуйте еще раз!</div>')
        }
        return false;*/
    });
